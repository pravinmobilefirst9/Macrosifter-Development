...
@Component({
    host: { class: 'h-100' },
    selector: 'gf-account-details-toggle-verification_failed-same-day',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./account-details-toggle/account-details-toggle.scss'],
    templateUrl: './account-details-verification_failed-same-day.html',
    imports: [MatButtonModule],
    standalone: true
})
export class AccountDetailsToggleVerificationFailedSameDayDialog implements OnDestroy {
    ...
    public constructor(
        ...
        public dialogRef: MatDialogRef<AccountDetailsToggleVerificationFailedSameDayDialog>,
