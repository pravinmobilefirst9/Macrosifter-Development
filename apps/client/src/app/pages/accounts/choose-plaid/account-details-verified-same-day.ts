...
@Component({
    host: { class: 'h-100' },
    selector: 'gf-account-details-toggle-verified-same-day',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./account-details-toggle/account-details-toggle.scss'],
    templateUrl: './account-details-verified-same-day.html',
    imports: [MatButtonModule],
    standalone: true
})
export class AccountDetailsToggleVerifiedSameDayDialog implements OnDestroy {
    ...
    public constructor(
        ...
        public dialogRef: MatDialogRef<AccountDetailsToggleVerifiedSameDayDialog>,
