...
@Component({
    host: { class: 'h-100' },
    selector: 'gf-account-details-toggle-pending-same-day',
    changeDetection: ChangeDetectionStrategy.OnPush,
    styleUrls: ['./choose-plaid-start-update-mode/account-details-toggle-pending.scss'],
    templateUrl: './account-details-pending-same-day.html',
    imports: [MatButtonModule],
    standalone: true
})
export class AccountDetailsTogglePendingSameDayDialog implements OnDestroy {
    ...
    public constructor(
        ...
        public dialogRef: MatDialogRef<AccountDetailsTogglePendingSameDayDialog>,
